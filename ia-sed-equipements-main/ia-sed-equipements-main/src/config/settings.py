...
PATH_DATA_30min_Nuitee = DATA_DIR / "bdd_data_presence/Presence30min-Nuitee-Iris"
PATH_DATA_30min = DATA_DIR / "bdd_data_presence/Presence30min"
...
DEPARTEMENTS = ['69', '01', '42', '38'] # Pour élargir
